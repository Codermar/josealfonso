/*
drop table hr_cycleInfo cascade constraints;
drop type ngt_cycleInfo force;
*/

create or replace type ngt_cycleInfo as object(
   cached int
  ,cycleid number
  ,CycleName varchar2(75) 
  ,ToolID varchar2(25)
  ,CycleTypeID number
  ,cycleStartDate date
  ,CycleEndDate date
  ,CycleIsActive int
  ,ManagerCycleAccess varchar2(25)
  ,HRMCycleAccess varchar2(25)
  ,ManagerEditActivationDate date
  ,ManagerReadOnlyActivationDate date
  ,HRMrEditActivationDate date
  ,HRMReadOnlyActivationDate date
  ,HRGLetterEnableDate date
  ,ManagerLetterEnableDate date
  ,forceLoad int
  ...
  ,member function get return ngt_cycleInfo
  ,member function setFromTables return ngt_cycleInfo
...
-- persist the objects
CREATE TABLE hr_cycleInfo OF ngt_cycleInfo
(
   CONSTRAINT hr_cycleInfo_pk PRIMARY KEY (cycleID)
);
/
/*
